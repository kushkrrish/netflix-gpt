    ...
    return (
        <div >
            ...
            <form onSubmit={(e) => {
                ...
                {signIn && <input ref={displayName} type="text" placeholder="Full Address" className="p-3 my-3 w-full bg-gray-700 text-white font-extrabold" />}
                ...
                <button className="my-3 p-3 bg-red-800 w-full text-whnpm install firebaseite font-bold rounded-s-sm" onClick={validate}>{signIn===false?"sign in":"sign up"}</button>
